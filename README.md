...
When using a separate parser such as TypeScript, or when adding the plugin to an
existing ESLint configuration and adjusting rules, configure it as follows.
